...
### Part F
Below is Bert-Ernie's incorrect code:
```{r}
...
Now we can implement this interval in R, noting that we only take the lower bound for the Bert-Ernie's purposes.
```{r}
